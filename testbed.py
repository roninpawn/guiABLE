from guiABLE2 import *

def test_gui():
    app = Windowable(geometry="600x400", title="guiABLE Testbed")
    ...
    test_btn = Pushable(app, lambda: print("Button clicked!"), skinnable=btn_skin, width=100, height=40)
    ...
    test_toggle = Toggleable(app, function=lambda: print("Toggle state:", test_toggle.state()),
    ...
    test_drag = Draggable(app, skinnable=drag_skin, width=50, height=50)
    ...
    test_label = Labelable(app, function=lambda: print("Label clicked!"), skinnable=label_skin,
    ...
    scrollpane = ScrollablePane(app, width=250, height=150, scrollable_pane_skin=pane_skin, auto=(True, True))
    ...
    hold_btn = Holdable(app, function=lambda: print("Holding..."), skinnable=hold_skin, width=100, height=40, delay=200)
    ...
    click_btn = Clickable(app, function=lambda: print("Clicked instantly!"), skinnable=click_skin, width=100, height=40)
    ...
    trough = Troughable(app, width=150, height=30, skinnable=trough_skin)
